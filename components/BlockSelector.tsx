  ...
  return (
    ...
    >
                ...
                >
                  <div className="mt-2 flex flex-col gap-1.5 pl-2">
                    ...
                    <motion.button
                      ...
                      className="flex items-center justify-between w-full border-2 border-dashed border-zinc-200 dark:border-zinc-700 rounded-xl px-3 py-2.5 hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors"
                      whileHover={{ x: 2 }}
                      whileTap={{ scale: 0.97 }}
                    >
                    ...
                    {block.topics.map((topic, ti) => {
                      ...
                      return (
                        <motion.button
                          ...
                          className="flex items-center justify-between w-full bg-white dark:bg-[#1a1828] border border-zinc-200 dark:border-zinc-800 rounded-xl px-3 py-2.5 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors text-left group"
      ...
      <motion.button
        ...
        whileHover={{ scale: 1.005 }}
        whileTap={{ scale: 0.98 }}
        className="w-full flex items-center justify-between bg-white dark:bg-[#1a1828] border-2 border-zinc-200 dark:border-zinc-800 rounded-2xl p-4 hover:border-zinc-300 dark:hover:border-zinc-700 transition-colors duration-200 shadow-sm text-left"
      >
        <div className="flex-1 min-w-0">
